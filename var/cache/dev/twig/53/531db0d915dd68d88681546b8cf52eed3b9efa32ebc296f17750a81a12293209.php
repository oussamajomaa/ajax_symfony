...
class __TwigTemplate_661b2bbb9b16cf0d9fce4157a0b998d4fe35cc4fd9416246dd2c11e92e38f322 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function macro_set_handler($__controller__ = null, $__route__ = null, $__method__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["controller"] ?? null), "class", [], "any", true, true, false, 289)) {
                // line 290
                if (((array_key_exists("method", $context)) ? (_twig_default_filter((isset($context["method"]) || array_key_exists("method", $context) ? $context["method"] : (function () { throw new RuntimeError('Variable "method" does not exist.', 290, $this->source); })()), false)) : (false))) {
                ...
                // line 294
                if (((array_key_exists("route", $context)) ? (_twig_default_filter((isset($context["route"]) || array_key_exists("route", $context) ? $context["route"] : (function () { throw new RuntimeError('Variable "route" does not exist.', 294, $this->source); })()), false)) : (false))) {
                    // line 295
                    echo "@";
...
{% macro set_handler(controller, route, method) %}
    ...
    {%- endif %}
{% endmacro %}
", "@WebProfiler/Collector/request.html.twig", "/var/www/html/cours-ajax/vendor/symfony/web-profiler-bundle/Resources/views/Collector/request.html.twig");
    }
}
